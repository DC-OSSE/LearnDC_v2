...
isa <- sqlQuery(dbrepcard_prod,"select * from equity_report_school_longitudinal where metric in ('In-Seat Attendance Rate') and school_year ='2016-2017' and reported=1") %>% 
