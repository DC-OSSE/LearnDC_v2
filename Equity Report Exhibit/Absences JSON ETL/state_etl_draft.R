...
state_abs <- select(abs_wide[which(abs_wide$school_code=='0161'),],year,subgroup,'1-5_days'=state_1_5_days,'6-10_days'=state_6_10_days,'11-15_days'=state_11_15_days,'16-25_days'=state_16_25_days,more_than_25_days=state_more_than_25_days)
