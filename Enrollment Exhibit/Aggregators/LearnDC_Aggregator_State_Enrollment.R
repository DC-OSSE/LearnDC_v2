...
state_subgroups_df$grade[which(state_subgroups_df$grade == "PS")] <- "grade PK3"
state_subgroups_df$grade[which(state_subgroups_df$grade == "PK")] <- "grade PK4"
state_subgroups_df$grade[which(state_subgroups_df$grade == "KG")] <- "grade KG"
...
state_subgroups_df$grade[which(state_subgroups_df$grade == "UN")] <- "ungraded"
