...
school_hqt$lea_code[which(school_hqt$lea_code!='001')] <- '000'
school_hqt$lea_name[which(school_hqt$lea_code!='001')] <- 'CHARTER SECTOR LEA'
school_hqt$lea_code[which(school_hqt$lea_code=='001')] <- '001'
school_hqt$lea_name[which(school_hqt$lea_code=='001')] <- 'DISTRICT OF COLUMBIA PUBLIC SCHOOLS'
